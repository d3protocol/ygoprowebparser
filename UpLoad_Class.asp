...
'=========================================================
 ...
 '作者: Anlige
 '版本: 艾恩ASP无组件上传类V12.0921
 '开发日期: 2008-04-12
 '修改日期: 2012-09-21(增加对HTML5文件多选的支持)
 '主页: http://dev.mo.cn
...
Class AnUpLoad
	...
	Public Function Files(ByVal formname)
		If trim(formname) = "-1" Then
			Set Files = Fils
		Else
			If Fils.Exists(LCase(formname) & vMuti & "0") Then
				Set Files = Fils(LCase(formname) & vMuti & "0")
			Else
	...
	'==============================
	'获取上传的文件类,支持HTML5,参数可选,如果为-1则返回一个包含所有上传文件类的一个dictionary对象
	'==============================
